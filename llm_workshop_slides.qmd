...
::: {.resultbox}
**If you can't show your LLM annotation pipeline replicates itself, you don't yet know whether it replicates anything else.**
:::

::: {.notes}
Closing slide — let this sit for a moment rather than moving straight to references. It ties together all four findings: stability is a precondition, not a guarantee, and it's the one precondition you can actually test cheaply, yourself, before you build a paper on top of an LLM-coded variable.
:::
